package com.hephzibah.spark.jobs.RealTimeFraudDetection

import com.hephzibah.cassandra.dao.{KafkaOffsetRepository, CreditcardTransactionRepository}
import com.hephzibah.cassandra.{CassandraDriver, CassandraConfig}
import com.hephzibah.config.Config
import com.hephzibah.creditcard.Schema
import com.hephzibah.kafka.KafkaConfig
import com.hephzibah.spark.{DataReader, GracefulShutdown, SparkConfig}
import com.hephzibah.spark.jobs.SparkJob
